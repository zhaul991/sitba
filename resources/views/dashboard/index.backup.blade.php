...
<div class="space-y-6 py-6">
    ...
    <div
        class="relative overflow-hidden rounded-3xl bg-gradient-to-br
               from-slate-950 via-blue-950 to-blue-700 text-white
    ...
    >
        ...
        <div class="pointer-events-none absolute -bottom-32 left-1/3 h-80 w-80 rounded-full bg-blue-400/10 blur-3xl"></div>
        ...
        <div class="relative p-6 md:p-8">
            ...
            <div class="flex flex-col gap-8 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div class="max-w-3xl">
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <span
                            class="inline-flex items-center rounded-full border border-white/15
                                   ...
                                   tracking-[0.16em] text-blue-100 backdrop-blur"
                        >
                            Dashboard Eksekutif
                        </span>
                    ...
                    <p class="mt-6 text-sm font-semibold text-sky-300">
                    ...
                    <p class="mt-4 max-w-2xl text-sm leading-7 text-blue-100 md:text-base">
                    ...
                    @if ($tindakLanjutOverdue > 0)
                        ...
                        <div
                            class="mt-6 inline-flex max-w-xl items-start gap-3 rounded-2xl
                                   border border-red-300/30 bg-red-500/15 px-4 py-3
                                   backdrop-blur-sm"
                        >
                            <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-red-400/20">
                                ⚠
                            </span>

                            <div>
                                <p class="text-sm font-black uppercase tracking-wider text-red-100">
                                    Perlu Perhatian
                                </p>

                                <p class="mt-1 text-sm leading-5 text-red-50">
                                    Terdapat {{ number_format($tindakLanjutOverdue) }}
                                    tindak lanjut yang telah melewati deadline.
                                </p>
                            </div>
                        </div>
                    ...
                    @else
                        ...
                        <div
                            class="mt-6 inline-flex max-w-xl items-start gap-3 rounded-2xl
                                   border border-emerald-300/30 bg-emerald-400/15 px-4 py-3
                                   backdrop-blur-sm"
                        >
                            <span class="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-emerald-400/20">
                                ✓
                            </span>

                            <div>
                                <p class="text-sm font-black uppercase tracking-wider text-emerald-100">
                                    Sistem Aman
                                </p>

                                <p class="mt-1 text-sm leading-5 text-emerald-50">
                                    Seluruh tindak lanjut masih berada dalam batas waktu.
                                </p>
                            </div>
                        </div>
                ...
                {{-- Date and live clock --}}
                <div
                    class="w-full rounded-3xl border border-white/15 bg-white/10
                           p-5 shadow-lg backdrop-blur-md xl:w-auto xl:min-w-72"
                >
                    ...
                    <div class="flex items-end justify-between gap-5">
                        <div>
                            ...
                            <p
                                ...
                                class="mt-1 text-3xl font-black tabular-nums tracking-tight"
                            >
                                {{ now()->format('H:i:s') }}
                            </p>
                        </div>
    ...
    <div class="grid gap-6 xl:grid-cols-3">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Perbandingan risiko rendah dan tinggi.
                </p>
            </div>

            @if (($risikoRendah + $risikoTinggi) > 0)

                <div class="mx-auto mt-6 h-56 max-w-xs">
                    <canvas id="grafikDistribusiRisiko"></canvas>
                </div>

                <div class="mt-6 grid grid-cols-2 gap-3">

                    <a
                        href="{{ route('temuan.index', array_filter([
                            'bandara_id' => $bandaraId,
                            'tingkat_risiko' => 'Rendah',
                        ])) }}"
                        class="rounded-xl bg-emerald-50 p-4 transition hover:bg-emerald-100"
                    >
                    ...
                    <a
                        ...
                        class="rounded-xl bg-red-50 p-4 transition hover:bg-red-100"
                    >
                        <div class="flex items-center gap-2">
            ...
            @else
                ...
                <div class="mt-6 flex h-72 flex-col items-center justify-center rounded-xl bg-slate-50 text-center">
                    ...
                    <p class="mt-1 text-sm text-slate-500">
                        Distribusi risiko akan muncul setelah data temuan tersedia.
                    </p>
    ...
    <div class="grid gap-6 xl:grid-cols-3">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div>
                ...
                <p class="mt-1 text-sm text-slate-500">
                    Distribusi risiko temuan inspeksi.
                </p>
            </div>
            ...
            <div class="mt-6 space-y-5">
                ...
                <div>
                    ...
                    <div class="h-2.5 overflow-hidden rounded-full bg-red-100">
                    ...
                    <p class="mt-1.5 text-xs text-slate-500">
                        {{ $persentaseRisikoTinggi }}% dari data risiko
                    </p>
                ...
                <div>
                    ...
                    <p class="mt-1.5 text-xs text-slate-500">
                        {{ $persentaseRisikoRendah }}% dari data risiko
                    </p>
    ...
    {{-- Bandara terbanyak dan deadline --}}
    <div class="grid gap-6 xl:grid-cols-2">
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
            ...
            <div class="mt-6 space-y-4">
                ...
                @forelse ($bandaraTerbanyak as $index => $bandara)
                    ...
                    @php
                        $jumlahTertinggi = max(
                            $bandaraTerbanyak->max('jumlah_temuan'),
                            1
                        );

                        $lebarBar = ($bandara->jumlah_temuan / $jumlahTertinggi) * 100;
                    @endphp
                    ...
                    <a
                        ...
                        class="group block rounded-xl p-3 transition
                               hover:bg-blue-50"
                    >
                        ...
                        <div class="mb-2 flex items-center justify-between gap-4">
                            ...
                            <div class="flex min-w-0 items-center gap-3">
                                ...
                                <span class="flex h-7 w-7 shrink-0 items-center
                            ...
                            <div class="flex shrink-0 items-center gap-2">
                                ...
                                <span class="text-sm text-slate-300 transition
                        ...
                        <div class="ml-10 h-2 overflow-hidden rounded-full
                                    bg-slate-100">
                        ...
                        <p class="ml-10 mt-2 hidden text-xs font-medium
                                  text-blue-600 group-hover:block">
                            Lihat seluruh temuan bandara
                        </p>
                ...
                @empty
                    ...
                    <div class="py-10 text-center text-sm text-slate-500">
                        Belum tersedia data temuan bandara.
                    </div>
