                            ...
                            <td class="px-6 py-4">
                                ...
                                @if ($item->petugas->count())
                                    ...
                                    @if ($item->petugas->count() > 3)
                                        ...
                                        <button
                                            type="button"
                                            onclick='bukaModalInspektur(@json($item->petugas))'
...
function bukaModalInspektur(petugas)
{

    const modal = document.getElementById('modal-inspektur');

    const list = document.getElementById('list-inspektur');

    const jumlah = document.getElementById('jumlah-inspektur');


    jumlah.innerHTML = petugas.length + ' personel terlibat';


    list.innerHTML = '';


    petugas.forEach((inspektur, index) => {
        ...
        list.innerHTML += `
            ...
            <div class="flex items-center gap-4 rounded-xl border border-gray-200 p-4">
                ...
                <div class="flex h-11 w-11 items-center justify-center rounded-full bg-blue-100 font-bold text-blue-700">
                    ${inspektur.nama_petugas.substring(0,2).toUpperCase()}
                </div>
