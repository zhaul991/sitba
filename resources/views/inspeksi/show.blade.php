    ...
    <div class="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-col gap-3 sm:flex-row">
                ...
                <a
                    href="{{ route('inspeksi.edit', $inspeksi) }}"
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="border-b border-gray-200 px-6 py-5">
                    ...
                    <p class="mt-1 text-sm text-gray-500">
                        Identitas dan keterangan kegiatan inspeksi.
                    </p>
                </div>
                    ...
                    <div class="sm:col-span-2">
                        <div class="border-t border-gray-100 pt-6">
                            ...
                            <p class="mt-3 whitespace-pre-line text-sm leading-7 text-gray-700">
                                {{ $inspeksi->keterangan ?: 'Tidak ada keterangan tambahan.' }}
                            </p>
            ...
            <div class="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="flex flex-col gap-4 border-b border-gray-200 px-6 py-5 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            Temuan yang tercatat dalam kegiatan inspeksi ini.
                        </p>
                    </div>
                ...
                @if ($inspeksi->temuans->isNotEmpty())
                    ...
                    <div class="border-t border-gray-200 bg-gray-50 px-6 py-4">
                        <p class="text-sm text-gray-500">
                            Menampilkan {{ $totalTemuan }} temuan dari kegiatan inspeksi ini.
                        </p>
                    </div>
