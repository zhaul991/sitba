...
<div class="p-6 md:p-8">
    ...
    <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-2 text-gray-500">
                Kelola seluruh kegiatan pemantauan bandar udara dalam sistem SITBA.
            </p>
        </div>
    ...
    <x-filter-panel
        title="Filter Data Pemantauan"
        description="Cari dan saring kegiatan pemantauan berdasarkan bandara, tahun, atau inspektur."
    >
        <form
            method="GET"
            action="{{ route('pemantauan.index') }}"
                            ...
                            <td class="px-6 py-4">
                                ...
                                @if ($item->petugas->count())
                                    ...
                                    <div class="space-y-1">
                                        ...
                                        @foreach ($item->petugas->take(5) as $inspektur)
                                    ...
                                    @if ($item->petugas->count() > 5)

                                        <div class="mt-2 text-xs font-semibold text-blue-600">
                                            +{{ $item->petugas->count() - 5 }} lainnya
                                        </div>
                        ...
                        <tr>
                            <td colspan="6" class="px-6 py-16 text-center">
                                ...
                                <p class="mt-3 font-semibold text-gray-700">
                                    Data pemantauan belum tersedia
                                </p>

                                <p class="mt-1 text-sm text-gray-500">
                                    Tambahkan kegiatan pemantauan pertama ke dalam sistem.
                                </p>
...
>
    ...
    <div class="flex h-[80vh] w-full max-w-lg flex-col overflow-hidden rounded-2xl bg-white p-6 shadow-xl">

        <div class="flex shrink-0 items-center justify-between border-b pb-4">
            ...
            <div>
                ...
                <p id="jumlah-inspektur" class="mt-1 text-sm text-gray-500"></p>
            </div>


            <button
                onclick="tutupModalInspektur()"
        ...
        <div
            id="list-inspektur"
            class="mt-4 flex-1 space-y-3 overflow-y-auto pr-2"
        ></div>
