    ...
    @if ($item->petugas->count() > 3)
        ...
        >
            ...
            >
                ...
                <div class="flex shrink-0 items-center justify-between border-b border-gray-200 pb-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">
                            {{ $item->petugas->count() }} personel terlibat
                        </p>
                    </div>
                    ...
                    <button
                        ...
                        class="rounded-full p-2 text-xl text-gray-400 hover:bg-gray-100 hover:text-gray-700"
                    >
                        &times;
                    </button>
